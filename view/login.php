...
<div class="two-tone-two">
  ...
  <div class="container">
    ...
    <button type="login" name="Login" ><b>Login</b></button>
    </form>
...
<div id="RegisterForm" class="modal">
  ...
  <form class="modal-content animate" action="FRegister" method="post">
...
<div id="ChangePassForm" class="modal">
  ...
  <form class="modal-content animate" action="FChangePassword" method="post">
