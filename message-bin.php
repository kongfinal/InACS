            ...
            <div class="box with-title is-round">
                ...
                <div class="columns">
                    ...
                    <div class="div-message">
                        ...
                        <button class="message" onClick="document.location.href='message-bin.php'"><b>ถังขยะ</b></button><br>
                        <br><br><br><br><br>
                    </div>
                    </div>
                    ...
                    <br>
                    <div class="set-flex">
                        <h4 style="padding-top: 0; margin-top: 1.5%; margin-left: 3%; margin-right: 49.5%;">ถังขยะ</h4>
