            ...
            <div class="box with-title is-round">
                ...
                <div class="columns">
                    ...
                    <div class="div-message">
                        <button class="message-no-click" onClick="document.location.href='message.php'"><b>ข้อความทั้งหมด</b></button><br>
                        <button class="message" onClick="document.location.href='message-star.php'"><b>ติดดาว</b></button><br>
                    ...
                    <br>
                    <div class="set-flex">
                        <h4 style="padding-top: 0; margin-top: 1.5%; margin-left: 3%; margin-right: 49.3%;">ติดดาว</h4>
